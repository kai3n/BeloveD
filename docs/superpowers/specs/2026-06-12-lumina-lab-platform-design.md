...
| 히어로 | **에디토리얼 레프트**: 풀스크린 다이아몬드 영상 + 좌측 정렬 카피 + 캐러셀 인디케이터(01—03) + SCROLL TO EXPLORE |
| 히어로 영상 | `public/assets/diamond-hero-crisp.mp4` — hero-diamond-ring-crisp.png 기반 16s 핑퐁 줌 루프. 추후 실사 촬영 영상으로 교체 가능한 슬롯 구조 |
| 헤드라인 카피 (KO) | "진짜 다이아몬드. 더 현명한 선택." |
| 서브 카피 (KO) | "IGI 인증 랩그로운 다이아몬드 — 천연과 100% 동일한 물성, 채굴 프리미엄 없는 정직한 가격." |
