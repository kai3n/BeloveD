...
const COPY = {
  en: {
    ...
    cancelPolicyFree: "Cancel now and the order simply closes. If you've already sent the deposit, note it is non-refundable per our policy.",
    cancelPolicyPartial: "Design and production are underway, so the 30% deposit is non-refundable — it covers the work already done. Nothing beyond the deposit is charged.",
  ...
  ko: {
    ...
    cancelPolicyFree: "지금 취소하면 주문이 바로 종료됩니다. 이미 디파짓을 보내셨다면 정책상 환불되지 않는 점을 참고해 주세요.",
    cancelPolicyPartial: "디자인·제작이 진행 중이라 디파짓(30%)은 환불되지 않습니다 — 이미 진행된 작업을 충당해요. 디파짓 외 추가 청구는 없습니다.",
  ...
  zh: {
    ...
    cancelPolicyFree: "现在取消，订单将直接关闭。若已汇出定金，按政策不予退还。",
    cancelPolicyPartial: "设计与制作已在进行，定金（30%）不予退还 —— 用于抵付已完成的工作。除定金外不再收取任何费用。",
  ...
  es: {
    ...
    cancelPolicyFree: "Cancela ahora y el pedido simplemente se cierra. Si ya enviaste el depósito, ten en cuenta que no es reembolsable según nuestra política.",
    cancelPolicyPartial: "El diseño y la producción están en marcha, así que el depósito (30%) no es reembolsable — cubre el trabajo ya realizado. No se cobra nada más allá del depósito.",
