...
const COPY = {
  en: { title: "Messages", sub: "Live chat from the site. Reply here — visitors see it instantly; offline ones get an email.", open: "Open", all: "All", guest: "Guest", empty: "Select a conversation.", none: "No conversations yet.", placeholder: "Type a reply…  (Enter to send)", close: "Close", reopen: "Reopen", customer: "Customer", orders: "Orders", activity: "Recent activity", since: "since", noEmail: "no email on file", assignMe: "Assign to me", assigned: "Assigned", unassign: "Unassign", addTag: "+ tag", tagPh: "tag name", quick: "Quick replies", sOpen: "Open", sToday: "24h", sUnread: "Unread", sResp: "Avg reply (min)" },
  ko: { title: "메시지", sub: "사이트 라이브챗. 여기서 답장하면 방문자에게 즉시 표시되고, 오프라인이면 이메일로도 갑니다.", open: "진행중", all: "전체", guest: "방문자", empty: "대화를 선택하세요.", none: "아직 대화가 없어요.", placeholder: "답장 입력…  (Enter 전송)", close: "종료", reopen: "다시 열기", customer: "고객", orders: "주문", activity: "최근 활동", since: "가입", noEmail: "이메일 없음", assignMe: "나에게 배정", assigned: "담당", unassign: "배정 해제", addTag: "+ 태그", tagPh: "태그 이름", quick: "빠른 답변", sOpen: "진행중", sToday: "24시간", sUnread: "미확인", sResp: "평균 응답(분)" },
  zh: { title: "消息", sub: "网站在线聊天。在此回复，访客即时可见；离线访客会收到邮件。", open: "进行中", all: "全部", guest: "访客", empty: "选择一个对话。", none: "还没有对话。", placeholder: "输入回复…（Enter 发送）", close: "关闭", reopen: "重新打开", customer: "客户", orders: "订单", activity: "近期活动", since: "注册", noEmail: "无邮箱", assignMe: "分配给我", assigned: "负责", unassign: "取消分配", addTag: "+ 标签", tagPh: "标签名", quick: "快捷回复", sOpen: "进行中", sToday: "24小时", sUnread: "未读", sResp: "平均响应(分)" },
  es: { title: "Mensajes", sub: "Chat en vivo del sitio. Responde aquí — los visitantes lo ven al instante; los desconectados reciben un correo.", open: "Abierto", all: "Todos", guest: "Visitante", empty: "Selecciona una conversación.", none: "Aún no hay conversaciones.", placeholder: "Escribe una respuesta…  (Enter para enviar)", close: "Cerrar", reopen: "Reabrir", customer: "Cliente", orders: "Pedidos", activity: "Actividad reciente", since: "desde", noEmail: "sin correo", assignMe: "Asignarme", assigned: "Asignado", unassign: "Quitar", addTag: "+ etiqueta", tagPh: "nombre", quick: "Respuestas rápidas", sOpen: "Abiertos", sToday: "24h", sUnread: "Sin leer", sResp: "Resp. media (min)" },
};
