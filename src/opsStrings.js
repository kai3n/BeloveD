...
const en = {
  ...
  intake: {
    ...
    referenceSummary: (n, country, date) => `${n} reference file${n === 1 ? "" : "s"} · ${country} · ${date}`,
...
const ko = {
  ...
  intake: {
    ...
    referenceSummary: (n, country, date) => `레퍼런스 파일 ${n}개 · ${country} · ${date}`,
...
const zh = {
  ...
  intake: {
    ...
    referenceSummary: (n, country, date) => `${n} 个参考文件 · ${country} · ${date}`,
...
const es = {
  ...
  intake: {
    ...
    referenceSummary: (n, country, date) => `${n} archivo${n === 1 ? "" : "s"} de referencia · ${country} · ${date}`,
