...
const en = {
  ...
  intake: {
    ...
    wizardSteps: ["Product", "Center stone", "References"], reviewStep: "Review",
...
const ko = {
  ...
  intake: {
    ...
    wizardSteps: ["제품", "센터스톤", "레퍼런스"], reviewStep: "검토",
...
const zh = {
  ...
  intake: {
    ...
    wizardSteps: ["产品", "主石", "参考图"], reviewStep: "确认",
...
const es = {
  ...
  intake: {
    ...
    wizardSteps: ["Producto", "Piedra central", "Referencias"], reviewStep: "Revisar",
