...
const en = {
  ...
  intake: {
    ...
    wizardSteps: ["Product", "Center stone", "References"], next: "Next", back: "Back", requiredNote: "* Required field",
...
const ko = {
  ...
  intake: {
    ...
    wizardSteps: ["제품", "센터스톤", "레퍼런스"], next: "다음", back: "뒤로", requiredNote: "* 필수 항목",
...
const zh = {
  ...
  intake: {
    ...
    wizardSteps: ["产品", "主石", "参考图"], next: "下一步", back: "上一步", requiredNote: "* 必填项",
...
const es = {
  ...
  intake: {
    ...
    wizardSteps: ["Producto", "Piedra central", "Referencias"], next: "Siguiente", back: "Atrás", requiredNote: "* Campo obligatorio",
