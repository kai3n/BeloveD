...
const en = {
  ...
  login: {
    ...
    demoTitle: "Optional local demo account",
    ...
    errors: { rateLimited: "Too many attempts — try again in a minute.", badCredentials: "Invalid email or password.", emailExists: "This email is already registered.", wrongPortal: "This account uses a different sign-in.", badCode: "Invalid or inactive access code.", accountSuspended: "This account is suspended." },
  },
  diamonds: {
...
const ko = {
  ...
  login: {
    ...
    errors: { rateLimited: "시도가 너무 많습니다 — 1분 후 다시 시도해주세요.", badCredentials: "이메일 또는 비밀번호가 올바르지 않습니다.", emailExists: "이미 가입된 이메일입니다.", wrongPortal: "이 계정은 다른 로그인 경로를 사용합니다.", badCode: "유효하지 않거나 비활성된 접근 코드입니다.", accountSuspended: "정지된 계정입니다." },
  },
  diamonds: {
...
const zh = {
  ...
  login: {
    ...
    errors: { badCredentials: "邮箱或密码不正确。", emailExists: "该邮箱已注册。", wrongPortal: "该账户使用其他登录入口。", badCode: "访问码无效或已停用。", accountSuspended: "该账户已被停用。" },
  },
  diamonds: {
...
const es = {
  ...
  login: {
    ...
    demoTitle: "Cuenta demo local opcional",
    ...
    errors: { rateLimited: "Demasiados intentos — prueba en un minuto.", badCredentials: "Correo o contraseña incorrectos.", emailExists: "Este correo ya está registrado.", wrongPortal: "Esta cuenta usa otro acceso.", badCode: "Código de acceso inválido o inactivo.", accountSuspended: "Esta cuenta está suspendida." },
  },
  diamonds: {
