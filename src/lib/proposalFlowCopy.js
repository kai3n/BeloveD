...
export const PROPOSAL_FLOW_COPY = {
  en: {
    ...
    specTreatment: "Color treatment",
    treatDisclosed: "Post-growth color treated — disclosed on the lab report; stable for everyday wear.",
    ...
    listLabel: "Original price", couponSaved: "Coupon",
    ...
    pilotNote: "Pilot launch — we currently accept Zelle and Venmo. Credit card payment is coming soon.",
  ...
  ko: {
    ...
    specTreatment: "컬러 처리",
    treatDisclosed: "성장 후 컬러 처리 스톤 — 감정서에 명시되며, 데일리 착용에 안정적입니다.",
    ...
    listLabel: "정가", couponSaved: "쿠폰 할인",
    subTitle: "동급 대체 안내",
    ...
    pilotNote: "파일럿 운영 중 — 현재는 Zelle·Venmo로 결제를 받아요. 카드 결제도 곧 추가됩니다.",
  ...
  zh: {
    ...
    pilotNote: "试运行阶段 — 目前支持 Zelle 与 Venmo，信用卡支付即将上线。",
  ...
  es: {
    ...
    specTreatment: "Tratamiento de color",
    treatDisclosed: "Color tratado post-crecimiento — indicado en el certificado; estable para el uso diario.",
    ...
    listLabel: "Precio original", couponSaved: "Cupón",
    ...
    pilotNote: "Lanzamiento piloto — por ahora aceptamos Zelle y Venmo. El pago con tarjeta llegará pronto.",
