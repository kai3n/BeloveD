...
export const ERROR_CODES = [
  ...
  "VALIDATION_ERROR", "ORIGIN_NOT_ALLOWED", "INVALID_ORDER_TRANSITION",
  "ORDER_TRANSITION_REQUIRES_EVENT", "ORDER_PREREQUISITE_MISSING",
  "EVENT_ALREADY_RECORDED", "PAYMENT_REPORT_REQUIRED", "PAYMENT_ALREADY_REPORTED",
  "SHIPPING_ADDRESS_LOCKED",
  "SUPPLIER_AUTH_REQUIRED", "SUPPLIER_NOT_FOUND", "SUPPLIER_EMAIL_EXISTS",
  "SUPPLIER_INVITE_INVALID", "SUPPLIER_PASSWORD_RESET_INVALID",
  "INVENTORY_NOT_FOUND", "INVENTORY_SKU_EXISTS",
];
