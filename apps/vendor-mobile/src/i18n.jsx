...
const en = {
  ...
  "关闭": "Close", "内容类型": "Content type", "CAD / 方案": "CAD / Proposal", "成品质检": "Finished-piece QC", "从手机选择照片或视频": "Choose photos or videos from your phone", "支持 JPG、PNG、WebP、MP4 · 视频最大 30MB": "JPG, PNG, WebP, MP4 · videos up to 30MB",
  "进度说明（选填）": "Update note (optional)", "说明这次更新完成了什么、下一步是什么…": "Describe what was completed and what comes next…", "安全直传": "Secure direct upload", "文件从手机直接上传到腾讯云 COS，API 只保存文件地址。": "Files upload directly from the phone to Tencent Cloud COS; the API stores only the file URL.", "正在上传…": "Uploading…", "确认上传": "Confirm upload", "上传到": "Upload to",
...
const ko = {
  ...
  "内容类型": "콘텐츠 유형", "CAD / 方案": "CAD / 제안", "成品质检": "완성품 검수", "从手机选择照片或视频": "휴대폰에서 사진 또는 영상 선택", "支持 JPG、PNG、WebP、MP4 · 视频最大 30MB": "JPG, PNG, WebP, MP4 · 영상 최대 30MB",
  "进度说明（选填）": "진행 설명(선택)", "说明这次更新完成了什么、下一步是什么…": "완료한 작업과 다음 단계를 적어주세요…", "安全直传": "안전한 직접 업로드", "文件从手机直接上传到腾讯云 COS，API 只保存文件地址。": "파일은 휴대폰에서 Tencent COS로 바로 업로드되고 API에는 주소만 저장됩니다.", "正在上传…": "업로드 중…", "确认上传": "업로드 확인", "上传到": "업로드 대상",
